(function(editors, elFinder) {
	...
	var apps = {},
		...
		initImgTag = function(id, file, content, fm) {
			var node = $(this).children('images:first').data('ext', getExtention(file.mime, fm)),
		...
		pixlrLoad = function(mode, base) {
			var self = this,
				...
				node = $(base).children('images:first')
					.data('loading')()
	...
	return [
		{
			...
			info : {
				...
				iconImg: 'images/editor-icons.png 0 -48',
				dataScheme: true,
				schemeContent: true,
				openMaximized: true,
				canMakeEmpty: false,
			...
			setup : function(opts, fm) {
				if (fm.UA.ltIE8 || fm.UA.Mobile) {
					...
					this.opts = Object.assign({}, opts.extraOptions.tuiImgEditOpts || {}, {
						iconsPath : fm.baseUrl + 'images/tui-',
						theme : {}
					});
		...
		},
		{
			...
			info : {
				id : 'pixlreditor',
				name : 'Pixlr Editor',
				iconImg : 'images/editor-icons.png 0 -128',
				urlAsContent: true,
				schemeContent: true,
				single: true,
				canMakeEmpty: true,
			...
			// HTML of this editor
			html : '<div class="elfinder-edit-imageeditor"><images/></div>',
			// called on initialization of elFinder cmd edit (this: this editor's config object)
			setup : function(opts, fm) {
			...
			getContent : function() {
				return $(this).children('images:first').attr('src');
			},
			load : function(base) {
		...
		},
		{
			...
			info : {
				id: 'pixlrexpress',
				name : 'Pixlr Express',
				iconImg : 'images/editor-icons.png 0 -112',
				urlAsContent: true,
				schemeContent: true,
				single: true,
				canMakeEmpty: false,
		...
		},
		{
			...
			info : {
				id : 'photopea',
				name : 'Photopea',
				iconImg : 'images/editor-icons.png 0 -160',
				single: true,
				urlAsContent: true,
		...
		},
		{
			...
			info : {
				id : 'creativecloud',
				name : 'Creative Cloud',
				iconImg : 'images/editor-icons.png 0 -192',
				dataScheme: true,
				schemeContent: true,
				single: true,
				canMakeEmpty: false,
			...
			save : function(base) {
				var node = $(base).children('images:first');
		...
		},
		{
			...
			info : {
				id : 'aceeditor',
				name : 'ACE Editor',
				iconImg : 'images/editor-icons.png 0 -96'
			},
		...
		},
		{
			...
			info : {
				id : 'codemirror',
				name : 'CodeMirror',
				iconImg : 'images/editor-icons.png 0 -176'
			},
			load : function(textarea) {
				var fm = this.fm,
		...
		},
		{
			...
			info : {
				id : 'simplemde',
				name : 'SimpleMDE',
				iconImg : 'images/editor-icons.png 0 -80'
			},
			exts  : ['md'],
			load : function(textarea) {
				var self = this,
		...
		},
		{
			...
			info : {
				id : 'ckeditor',
				name : 'CKEditor',
				iconImg : 'images/editor-icons.png 0 0'
			},
			exts  : ['htm', 'html', 'xhtml'],
			setup : function(opts, fm) {
		...
		},
		{
			...
			info : {
				id : 'ckeditor5',
				name : 'CKEditor5',
				iconImg : 'images/editor-icons.png 0 -16'
			},
			exts : ['htm', 'html', 'xhtml'],
		...
		},
		{
			...
			info : {
				id : 'tinymce',
				name : 'TinyMCE',
				iconImg : 'images/editor-icons.png 0 -64'
			},
			exts  : ['htm', 'html', 'xhtml'],
			setup : function(opts, fm) {
		...
		},
		{
			info : {
				id : 'zohoeditor',
				name : 'Zoho Editor',
				iconImg : 'images/editor-icons.png 0 -32',
				cmdCheck : 'ZohoOffice',
				preventGet: true,
				hideButtons: true,
				syncInterval : 15000,
		...
		},
		{
			...
			info : {
				id : 'ziparchive',
				name : 'btnMount',
				iconImg : 'images/toolbar.png 0 -416',
				cmdCheck : 'ZipArchive',
		...
		},
		{
			...
			info : {
				id : 'onlineconvert',
				name : 'Online Convert',
				iconImg : 'images/editor-icons.png 0 -144',
