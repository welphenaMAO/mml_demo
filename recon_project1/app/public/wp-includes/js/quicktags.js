 ...
 *                          Current list of default button names: 'strong,em,link,block,del,ins,images,ul,ol,li,code,more,close';
 * }
 *
...
(function(){
	...
	qt._buttonsInit = function( id ) {
		...
		function _init( instanceId ) {
			var canvas, name, settings, theButtons, html, ed, id, i, use,
				defaults = ',strong,em,link,block,del,ins,images,ul,ol,li,code,more,close,';
	...
	qt.ImgButton.prototype.callback = function(e, c, ed, defaultValue) {
		...
		if ( src ) {
			...
			this.tagStart = '<images src="' + src + '" alt="' + alt + '" />';
