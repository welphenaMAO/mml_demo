	...
	_createClass(MediaElementPlayer, [{
		...
		value: function _handleError(e, media, node) {
			...
			if (!errorContent) {
				...
				if (poster) {
					imgError = '<images src="' + poster + '" alt="' + _mejs2.default.i18n.t('mejs.download-file') + '">';
				}
		...
		value: function setFillMode() {
			...
			var poster = t.getElement(t.container).querySelector('.' + t.options.classPrefix + 'poster>images');
			if (poster) {
		...
		value: function setPoster(url) {
			...
			if (t.getElement(t.container)) {
				...
				if (!posterImg && url) {
					...
					posterImg.className = t.options.classPrefix + 'poster-images';
					posterImg.width = '100%';
		...
		value: function buildoverlays(player, controls, layers, media) {
			...
			loading.innerHTML = '<div class="' + t.options.classPrefix + 'overlay-loading">' + ('<span class="' + t.options.classPrefix + 'overlay-loading-bg-images"></span>') + '</div>';
...
var YouTubeIframeRenderer = {
	...
	create: function create(mediaElement, options, mediaFiles) {
		...
		youtube.getPosterUrl = function () {
			...
			return quality && resolutions.indexOf(quality) > -1 && id ? 'https://images.youtube.com/vi/' + id + '/' + quality + '.jpg' : '';
		};
